...
#if defined(BRD_sx1272_radio) || defined(BRD_sx1276_radio) || defined(BRD_LoRa_E5_radio)
/*
 * control radio TCXO power (0=off, 1=on)
 * (return if TCXO is present and in use)
 */
bool hal_pin_tcxo (u1_t val);
#endif // defined(BRD_sx1272_radio) || defined(BRD_sx1276_radio) || defined(BRD_LoRa_E5_radio)
